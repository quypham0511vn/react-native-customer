...
const iconDelete = require('../../assets/images/ic_delete_character.png');
                ...
                <View style={[defaultStyles.buttonContainer, buttonContainerStyle]}>
                    ...
                    <View style={defaultStyles.pinNumberRow}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[buttonStyle, defaultStyles.wrapIcon]}
                        >
                            <Image style={defaultStyles.image} source={iconDelete} />
                        </TouchableOpacity>
                    </View>
                </View>
        ...
        items.push(
            <Text
                ...
                style={{
                    ...
                    backgroundColor: pin.length >= i ? COLORS.GREEN : COLORS.WHITE,
                    overflow: 'hidden',
                    marginHorizontal: 8,
                    borderWidth: 1,
